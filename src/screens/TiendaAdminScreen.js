...
const styles = StyleSheet.create({
  ...
  infoTitle: { fontSize: 18, fontFamily: theme.fonts.bold, color: theme.colors.primary, marginTop: 8 },
  ...
  label: { fontSize: 12, fontFamily: theme.fonts.bold, color: theme.colors.onSurfaceVariant, textTransform: 'uppercase', marginBottom: 8 },
  input: {
    height: 48,
    borderWidth: 1,
  ...
  addBtnText: { color: theme.colors.onPrimary, fontSize: 12, fontFamily: theme.fonts.bold },
  ...
  metodoBanco: { fontSize: 14, fontFamily: theme.fonts.bold, color: theme.colors.onSurface },
  ...
  viewStoreText: { color: theme.colors.primary, fontFamily: theme.fonts.bold, fontSize: 15 },
  logoutBtn: {
    flexDirection: 'row',
  ...
  logoutText: { color: theme.colors.error, fontFamily: theme.fonts.bold, fontSize: 15 },
  ...
  labelModal: { fontSize: 12, fontFamily: theme.fonts.medium, color: theme.colors.onSurfaceVariant, marginTop: 12, marginBottom: 4 },
  inputModal: {
    height: 48,
    borderWidth: 1,
    borderColor: theme.colors.outline,
